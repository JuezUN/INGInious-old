...
import tempfile
import os.path
from inginious.frontend.webapp.pages.course_admin.task_edit import CourseEditTask
...
def grader_generator_tab(course, taskid, task_data, template_helper):
    ...
    template_helper.add_javascript('/static/grader_generator/js/grader_generator.js')
...
def init(plugin_manager, course_factory, client, config):
    plugin_manager.add_page(r'/static/grader_generator/(.*)', create_static_resource_page(_BASE_STATIC_FOLDER))
